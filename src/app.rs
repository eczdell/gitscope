...
pub struct AppState {
    ...
    // Gists view
    pub gists_scroll: usize,
    pub gists_lines: Vec<String>,
    pub gists_lines_full: Vec<String>,
    pub gists_cursor: usize,
    pub gists_filter_input: String,
    pub gists_filter_text: String,
    ...
    pub repos: Vec<crate::repos::RepoEntry>,
    pub repos_cursor: usize,
    pub repos_scroll: usize,
    pub repos_add_input: String,
